# 🔍 Diagnosis: Why Data Not Saved to MongoDB

## ❌ Problem

No data for property, utility, and shutoff seen in MongoDB Atlas.
...
**⚠️ If server is not running, data cannot be saved to MongoDB!**
...
### ✅ Step 3: Add Data in App and Check Logs
...
### ✅ Step 4: Check App Status Indicator

**At top of Shutoffs list page:**

- **Green "✅ MongoDB Connected"** = Normal ✅
- **Orange "⚠️ Local Storage Only"** = Server not connected ❌

**If showing orange:** Check steps 1 and 2.
...
```powershell
$body = @{
    id = "test-property-$(Get-Date -Format 'yyyyMMddHHmmss')"
    name = "Test Property"
