...
async function connectDB() {
  ...
  try {
    ...
    try {
      ...
      console.error('   1. MongoDB Atlas Cluster may be Paused');
      console.error('   2. Network or firewall blocking the connection');
      console.error('   3. Node.js version (recommend Node.js 18+)');
      console.error('   4. MongoDB Atlas service issue');
      console.error('');
      console.error('Steps to fix:');
      console.error('   1. Visit https://cloud.mongodb.com');
      console.error('   2. Check Cluster "Haven" status (should be Active)');
      console.error('   3. If Cluster is Paused, click "Resume" to restore it');
      console.error('   4. Wait a few minutes for the cluster to start');
      console.error('   5. Check Network Access (IP must be whitelisted)');
      console.error('   6. If it still fails, try updating Node.js to the latest version');
      console.error('='.repeat(60));
      console.error('');
      throw connectError;
    }
